...
from model import b_S, b_N1, b_H1
...
if False:
	out_prefix="Im3-wo-N2-"
	b_S.remove(b_S.particles["N2"])
if False:
	out_prefix += "wo-H4H5-"
	b_S.remove(b_S.particles["H4"])
	b_S.remove(b_S.particles["H5"])
if True:
	out_prefix="Im3-N1H1H2H5-"
	b_S.remove(b_S.particles["N2"])
	b_S.remove(b_S.particles["H3"])
	b_S.remove(b_S.particles["H4"])

	if False:
		out_prefix="Im3-N1H1H2-"
		b_S.remove(b_S.particles["H5"])
	if False:
		out_prefix="Im3-N1H1-"
		b_S.remove(b_S.particles["H5"])
